...
bool getElement_test(string & error, bool testCircular = false) {
...
bool insert_test(string & error, bool testCircular = false) {
    LinkedList<Node> newList;
...
// -------------------------------------------------------------------------------------------------
// This test depends on prior tests working.
bool erase_test(string & error, bool testCircular = false) {
...
void runTests(vector<pair<bool, string>> results, string error) {
